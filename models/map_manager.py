...
class MapManager:
  ...
  def random_map( self, world ):
    ...
    #   
    #   
    #   my_obstacles.append( [ w, h, x, y, theta ] )
    # 
    # 
    # obstacles = []
    # for o in my_obstacles:
    #   obstacles.append( RectangleObstacle( o[0], o[1], Pose( o[2], o[3], o[4] ) ) )
    # goal = [ 0.9, 1.1 ]
